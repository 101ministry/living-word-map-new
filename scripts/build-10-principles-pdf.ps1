# Build 10 Principles HTML -> PDF

$ErrorActionPreference = 'Stop'
$Root = Split-Path $PSScriptRoot -Parent
$OutHtml = Join-Path $Root 'data\10-Principles.html'
$OutPdf  = Join-Path $Root 'data\10-Principles.pdf'
$OutPdfTitled = Join-Path $Root 'data\10 Principles.pdf'
