# Build Matthew 6:33 Protocol HTML -> PDF

$ErrorActionPreference = 'Stop'
$Root = Split-Path $PSScriptRoot -Parent
$OutHtml = Join-Path $Root 'data\Matthew-6-33-Protocol.html'
# Windows filenames cannot contain a colon; document title remains "Matthew 6:33 Protocol"
$OutPdf  = Join-Path $Root 'data\Matthew 6.33 Protocol.pdf'
...
$tmpPdf = Join-Path $Root 'data\_tmp-matthew-633-protocol.pdf'
