# Build Forgiveness vs Abuse study HTML -> PDF

$ErrorActionPreference = 'Stop'
$Root = Split-Path $PSScriptRoot -Parent
$OutHtml = Join-Path $Root 'data\FORGIVENESS-VS-ABUSE.html'
$OutPdf  = Join-Path $Root 'data\FORGIVENESS-VS-ABUSE.pdf'
$OutPdfTitled = Join-Path $Root 'data\Forgiveness vs Abuse.pdf'
