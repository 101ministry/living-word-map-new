# Build The Treachery Mind study (Adultery, Neglect, Abandonment...) HTML -> PDF

$ErrorActionPreference = 'Stop'
$Root = Split-Path $PSScriptRoot -Parent
$OutHtml = Join-Path $Root 'data\TREACHERY-MIND-ADULTERY-NEGLECT.html'
$OutPdf  = Join-Path $Root 'data\TREACHERY-MIND-ADULTERY-NEGLECT.pdf'
$OutPdfTitled = Join-Path $Root 'data\The Treachery Mind.pdf'
