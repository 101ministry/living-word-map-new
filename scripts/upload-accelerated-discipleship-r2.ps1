# Upload Accelerated Discipleship r2-pieces to Cloudflare R2
param(
    [string]$SourceDir = "C:\Users\tweed\Downloads\Music\Accelerated Discipleship\r2-pieces",
    [string]$Bucket = "living-word-map-downloads",
    [string]$Prefix = "audio/accelerated-discipleship"
)
