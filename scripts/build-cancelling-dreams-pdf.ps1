# Build Cancelling Dreams HTML -> PDF

$ErrorActionPreference = 'Stop'
$Root = Split-Path $PSScriptRoot -Parent
$OutHtml = Join-Path $Root 'data\Cancelling-Dreams.html'
$OutPdfTemp = Join-Path $Root 'data\cancelling-dreams.pdf'
$OutPdf     = Join-Path $Root 'data\Cancelling Dreams.pdf'
