# Build Christianity Without Christ HTML -> PDF

$ErrorActionPreference = 'Stop'
$Root = Split-Path $PSScriptRoot -Parent
$OutHtml = Join-Path $Root 'data\Christianity-Without-Christ.html'
$OutPdf  = Join-Path $Root 'data\Christianity-Without-Christ.pdf'
$OutPdfTitled = Join-Path $Root 'data\Christianity Without Christ.pdf'
