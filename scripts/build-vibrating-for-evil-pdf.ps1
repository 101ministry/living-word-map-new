# Build THE POWER OF VIBRATING FOR EVIL (Ephesians 6:12 + Zodiac) HTML -> PDF

$ErrorActionPreference = 'Stop'
$Root = Split-Path $PSScriptRoot -Parent
$OutHtml = Join-Path $Root 'data\THE-POWER-OF-VIBRATING-FOR-EVIL.html'
$OutPdf  = Join-Path $Root 'data\THE-POWER-OF-VIBRATING-FOR-EVIL.pdf'
$OutPdfTitled = Join-Path $Root 'data\THE POWER OF VIBRATING FOR EVIL.pdf'
